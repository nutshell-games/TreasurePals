    ...
    public class TransitionSettingsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                if (transitionSettings.TransitionType == TransitionHelper.TweenType.none)
                {
                    EditorGUI.indentLevel += 1;
                ...
                else if (transitionSettings.TransitionType == TransitionHelper.TweenType.AnimationCurve)
                {
                    EditorGUI.indentLevel += 1;
                ...
                else
                {
                    ...
                    var easingFunction = TransitionHelper.GetTweenFunction(transitionSettings.TransitionType);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                if (transitionSettings != null)
                {
                    ...
                    // other
                    if (transitionSettings.TransitionType == TransitionHelper.TweenType.AnimationCurve)
